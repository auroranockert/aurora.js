(function() {
  var AuroraALACDecoder, Bitstream, Buffer, BufferList, CAFDemuxer, Float32, Float64, FormatIDtoAuroraID, FromFloat32, FromFloat64, HTTPSource, Stream, ToFloat32, ToFloat64;
  ...
  AuroraALACDecoder = (function() {
    ...
    AuroraALACDecoder.prototype.enqueueBuffer = function(buffer) {
      var array, format, i, input, output, result, _ref, _ref2, _ref3, _ref4;
      ...
      result.duration = this.metadata.format.framesPerPacket / this.metadata.format.samplingFrequency;
